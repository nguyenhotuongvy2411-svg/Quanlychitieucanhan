...
const { createGoal, getGoals, updateGoal, deleteGoal, getTotalSaved, getGoalProgress, searchGoalsByName, sortGoalsByDeadline, addSavedMoney,withdrawSavedMoney  } = require('../Controllers/goalController');
...
router.post('/add-saved', addSavedMoney);
